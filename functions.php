...
function hackeryou_styles(){
	...
	wp_enqueue_style('googleFonts', 'https://fonts.googleapis.com/css?family=Montserrat|Raleway');

	wp_enqueue_style('devicons', 'https://cdn.jsdelivr.net/devicons/1.8.0/css/devicons.min.css');

	wp_enqueue_style('devicons2', 'https://cdn.rawgit.com/konpa/devicon/master/devicon.min.css');
}
